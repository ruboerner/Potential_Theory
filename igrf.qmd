...
& = \frac{\mu_0}{4 \pi r^{2}} \left[  m_x \frac{x}{r} + m_y \frac{y}{r} + m_z \frac{z}{r} \right]
\end{align}
$$
...
m_y & = \frac{4 \pi}{\mu_0} a^3 h_1^1 = 1.18 \times 10^{22} \\
m_z & = \frac{4 \pi}{\mu_0} a^3 g_1^0 = -7.59 \times 10^{22}
\end{align}
$$
