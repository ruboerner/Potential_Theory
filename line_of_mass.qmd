...
The __vertical component__ of attraction $\dd g$ due to an element of area $\dd S$ on an infinite horizontal plane lamina with density $\rho$ bounded by the planes $z$ and $z+\mathrm{d}z$ is
...
![Attraction of a surface element $\mathrm{d} S$ of thickness $\dd z$.](images/lamina.excalidraw.svg){#fig-sS-sketch}
