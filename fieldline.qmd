...
![Planar view of magnetic field lines for L-shells $L=3$ up to $L=9$ (simplified).](images/3dearth%20(2).png){#fig-fieldlinesearth}

```{=html}
<iframe src="https://trinket.io/embed/glowscript/a4c2ce25089f?outputOnly=true" width="100%" height="600" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
```

## Differential geometry properties of field lines
